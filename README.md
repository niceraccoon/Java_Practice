...
**<span style="color:green">Average of the input numbers</span>**
...
**<span style="color:green">Operations on two input numbers</span>**
 ...
 **<span style="color:green">Read and output data</span>**

Output question “How are you?“. Define string variable answer. Read the value answer and output: “You are (answer)".

 **<span style="color:green">Output the input strings in the reverse order</span>**  
...
**<span style="color:green">Rearrangement of flowerpots and their position on a specific day</span>**
 ...
 **<span style="color:green">Sum of numbers except those dividing by 3</span>**
